          ...
          <Link href="/docs/intro">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Next.js의 기본 개념과 프로젝트 설정 방법을 알아봅니다.</CardDescription>
              </CardHeader>
            </Card>
          </Link>
    ...
    <>
        ...
        <div className="text-muted-foreground flex items-center gap-2">
          ...
          {slug.map((segment, index) => (
            <div key={index} className="flex items-center gap-2">
              ...
              <span className={index === slug.length - 1 ? 'text-foreground font-medium' : ''}>{segment}</span>
            </div>
          ))}
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            <code className="bg-muted rounded-md px-2 py-1">params.slug: {JSON.stringify(slug)}</code>
          </CardDescription>
        </CardHeader>
      </Card>
    </>
