  ...
  return (
    <article className="container">
      ...
      <div className="prose prose-slate dark:prose-invert max-w-none">
        <p className="lead">
          Next.js와 Shadcn UI를 사용하여 모던하고 아름다운 블로그를 만드는 방법을 알아보겠습니다. 이 튜토리얼에서는 기본적인 설정부터 배포까지 전
          과정을 다룹니다.
        </p>

        <h2>시작하기</h2>
        <p>
          Next.js는 React 기반의 풀스택 웹 프레임워크입니다. 서버 사이드 렌더링, 정적 사이트 생성 등 다양한 렌더링 전략을 제공하며, 개발자 경험을
          극대화시켜주는 여러 기능들을 제공합니다.
        </p>

        <h2>Shadcn UI 설정하기</h2>
        <p>
          Shadcn UI는 재사용 가능한 컴포넌트 모음으로, 아름다운 디자인과 접근성을 모두 갖추고 있습니다. 컴포넌트를 직접 소유할 수 있어 커스터마이징이
          자유롭다는 장점이 있습니다.
        </p>
      </div>
        ...
        <Link href="/blog/previous-post">
          <Card className="group hover:bg-muted/50 transition-colors">
            <CardHeader>
              ...
              <CardDescription className="line-clamp-2">Next.js를 시작하는 방법부터 프로젝트 구조, 기본 설정까지 상세히 알아봅니다.</CardDescription>
            </CardHeader>
          </Card>
        </Link>
